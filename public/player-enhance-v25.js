(() => {
  ...
  function makeMoviePortal(player) {
    ...
    portal.id = 'veloraPlaybackPortalV25';
    portal.className = 'veloraPlaybackGateV12 veloraPlaybackGateV13 veloraPlaybackPortalV25';
    ...
    const bindFrame = frame => {
      if (!frame || frame.dataset.veloraBoundV25 === '1') return;
      frame.dataset.veloraBoundV25 = '1';
  ...
  function addLiveGate(w) {
    if (!w || w.dataset.veloraLiveGateV25 === '1') return;
    w.dataset.veloraLiveGateV25 = '1';
